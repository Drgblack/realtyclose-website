        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://www.linkedin.com/company/zaza-technologies" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" 
              ...
              <a href="https://www.tiktok.com/@zazatechnologies" target="_blank" rel="noopener noreferrer" aria-label="TikTok" 
