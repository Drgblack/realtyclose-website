export default function ShimmerButton({ href, children, id }:{
  ...
  return (
    <a id={id} href={href}
       ...
       style={{
         background:"linear-gradient(135deg, var(--rc-primary) 0%, #3b82f6 50%, #8b5cf6 100%)",
         boxShadow: "0 4px 20px rgba(59, 130, 246, 0.4), inset 0 1px 0 rgba(255,255,255,0.2)"
       }}>
      {/* Animated background */}
      <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-600 via-violet-600 to-blue-600 bg-[length:200%_100%] opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-gradient-x" />
