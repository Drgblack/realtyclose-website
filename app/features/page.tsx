...
export default function FeaturesPage() {
  return (
    <PageShell title="Gmail-First Real Estate Assistant">
      ...
      <div className="mb-20">
        <h2 className="rc-h2 text-white mb-8 text-center">How it works in Gmail</h2>
      ...
      {/* Outcome Claims (replacing feature sections) */}
      
      {/* Save 30+ hours per transaction */}
      <div className="mb-20">
        <div className="text-center mb-10">
          <h2 className="rc-h2 text-white mb-4">Save 30+ hours per transaction</h2>
      ...
      <div className="mb-20">
        <div className="text-center mb-10">
          <h2 className="rc-h2 text-white mb-4">Protect every deal from email drop-offs</h2>
          <p className="text-slate-200 max-w-3xl mx-auto">
      ...
      <div className="mb-20">
        <div className="text-center mb-10">
          <h2 className="rc-h2 text-white mb-4">Consistent, on-brand client experience</h2>
          <p className="text-slate-200 max-w-3xl mx-auto">
      ...
      <div className="mb-20">
        <div className="text-center mb-10">
          <h2 className="rc-h2 text-white mb-4">Audit-ready compliance & oversight</h2>
          <p className="text-slate-200 max-w-3xl mx-auto">
      ...
      <div className="mb-20">
        <h2 className="rc-h2 text-white mb-12 text-center">Built for real estate professionals who live in Gmail</h2>
      ...
      <div className="mb-20">
        <h2 className="rc-h2 text-white mb-12 text-center">Why not just use...?</h2>
      ...
      <div className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 rounded-xl p-8 text-center">
        <h2 className="rc-h2 text-white mb-4">Ready to reclaim 30+ hours per transaction?</h2>
