    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-slate-700/50">
        ...
        <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10 pt-20 pb-16 text-center">
          ...
          <p className="text-xl text-slate-200 mb-8 max-w-3xl mx-auto">
            Gmail-first assistant to reply in seconds, keep deals moving, and stay audit-ready
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 py-16">
              ...
              <div className="space-y-4">
                ...
                {plan.key === "free" && (
                  <p className="text-xs text-slate-400 text-center">
                    Upgrade prompts appear when you hit limits
                  </p>
                )}
              </div>
            </div>
        ...
        <div className="mt-12 bg-orange-600/10 border border-orange-500/20 rounded-2xl p-6 text-center">
          <p className="text-slate-100">
            <span className="text-orange-300 font-semibold">⚠️</span> Most CRMs run <span className="font-bold text-white">$499–$1,800/mo</span> and still aren't Gmail-native. 
            <span className="text-blue-300 font-semibold"> RealtyClose starts at $29 and works where you already work.</span>
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 py-8">
        <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-2xl font-bold text-white mb-2">Plan comparison</h2>
          <p className="text-slate-300 mb-8">Compare outcomes across plans</p>

          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700/50">
                  <th className="text-left py-4 px-4 font-semibold text-white">Outcome</th>
                  ...
                  <th className="text-center py-4 px-4 font-semibold text-white">Team</th>
                </tr>
              </thead>
      ...
      <section className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-10 py-8">
        <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          <h3 className="text-xl font-bold text-white mb-6 text-center">Quick Questions</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <p className="text-blue-300 font-semibold mb-2">Why seat-based, not per-email?</p>
              <p className="text-slate-200 text-sm">Predictable cost; encourages everyday use.</p>
            </div>
            <div>
              <p className="text-blue-300 font-semibold mb-2">Who is each plan for?</p>
              <p className="text-slate-200 text-sm">Free = solo testing; Professional = solos/high-volume agents; Team = team leads/TCs; Enterprise = brokerages.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 py-8">
        <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          <h3 className="text-2xl font-bold text-white mb-2">Enterprise (Brokerage/TC)</h3>
          <p className="text-slate-300 mb-6">For 50+ seats and advanced controls.</p>
          
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <ul className="space-y-3 text-slate-200">
              <li>✓ SSO, advanced compliance exports, API & integrations</li>
              <li>✓ Custom integrations (MLS, CRM)</li>
              <li>✓ White label options</li>
              <li>✓ Advanced audit & reporting</li>
            </ul>
            <ul className="space-y-3 text-slate-200">
              <li>✓ Concierge onboarding & training</li>
      ...
      <section className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-10 py-16">
        <div className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 rounded-2xl p-8 text-center shadow-2xl">
          <h2 className="text-2xl font-bold text-white mb-4">
            Ready to reclaim 30+ hours per transaction?
          </h2>
          <p className="text-slate-100 mb-6 max-w-2xl mx-auto">
            Join thousands of real estate professionals who've transformed their email workflow with Gmail-first assistance.
          </p>
          ...
          <p className="text-slate-300">
            Used by TCs, team leads, solo agents, and compliance-focused brokerages
          </p>
        </div>
      </section>
    </div>
